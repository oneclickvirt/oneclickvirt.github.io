...
| `spiritlhl/oneclickvirt:20260619` | All-in-one version specific date version | Need fixed version |
| `spiritlhl/oneclickvirt:no-db` | Independent database version latest | No built-in database |
| `spiritlhl/oneclickvirt:no-db-20260619` | Independent database version specific date | No built-in database |
