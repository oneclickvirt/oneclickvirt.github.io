...
| `oneclickvirt/oneclickvirt:20260712` | All-in-one version specific date version | Need fixed version |
| `oneclickvirt/oneclickvirt:no-db` | Independent database version latest | No built-in database |
| `oneclickvirt/oneclickvirt:no-db-20260712` | Independent database version specific date | No built-in database |
