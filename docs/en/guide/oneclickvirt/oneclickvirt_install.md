...
| `spiritlhl/oneclickvirt:20251021` | All-in-one version specific date | Need fixed version |
| `spiritlhl/oneclickvirt:no-db` | Independent database version latest | No built-in database |
| `spiritlhl/oneclickvirt:no-db-20251021` | Independent database version specific date | No built-in database |
